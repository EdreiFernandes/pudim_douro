...
public interface VoteRepository extends JpaRepository<Vote, Integer> {
    ...
    List<CountedVote> countSecondPlaceInEdition(@Param("edition_id") Integer editionId);
    ...
    List<CountedVote> countThirdPlaceInEdition(@Param("edition_id") Integer editionId);
}
